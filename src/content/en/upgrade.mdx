...
- 🚀 **New High-Performance Engine**: Full builds are up to 5x faster, and incremental builds are over 100x faster, measured in microseconds. ([tailwindcss.com](https://tailwindcss.com/blog/tailwindcss-v4?utm_source=chatgpt.com))
- 💎 **Designed for the Modern Web**: Built on cutting-edge CSS features like cascade layers, registered custom properties with `@property`, and `color-mix()`. ([tailwindcss.com](https://tailwindcss.com/blog/tailwindcss-v4?utm_source=chatgpt.com))
- 🎯 **Simplified Installation**: Fewer dependencies, zero configuration, and just a single line of code in your CSS file. ([tailwindcss.com](https://tailwindcss.com/blog/tailwindcss-v4?utm_source=chatgpt.com))
- 📦 **First-Party Vite Plugin**: Tight integration for maximum performance and minimum configuration. ([tailwindcss.com](https://tailwindcss.com/blog/tailwindcss-v4?utm_source=chatgpt.com))
- 🔍 **Automatic Content Detection**: All of your template files are discovered automatically, with no configuration required. ([tailwindcss.com](https://tailwindcss.com/blog/tailwindcss-v4?utm_source=chatgpt.com))
- 📂 **Built-In Import Support**: No additional tooling necessary to bundle multiple CSS files. ([tailwindcss.com](https://tailwindcss.com/blog/tailwindcss-v4?utm_source=chatgpt.com))
- 🛠️ **CSS-First Configuration**: A reimagined developer experience where you customize and extend the framework directly in CSS instead of a JavaScript configuration file. ([tailwindcss.com](https://tailwindcss.com/blog/tailwindcss-v4?utm_source=chatgpt.com))
